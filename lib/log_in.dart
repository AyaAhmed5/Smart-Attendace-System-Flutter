...
//     final url = Uri.parse('http://testyasmeenasp2-001-site1.etempurl.com/api/Auth/UserLogin');
...
class _LoginScreenState extends State<LoginScreen> {
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 24, color: const Color.fromARGB(255, 252, 252, 252)),
                  ),
                ),
              ],
            ),
  ...
  Future<void> loginUser() async {
    final url = Uri.parse('http://testyasmeenasp2-001-site1.etempurl.com/api/Auth/UserLogin'); // Replace with your API URL
    final response = await http.post(
      url,
